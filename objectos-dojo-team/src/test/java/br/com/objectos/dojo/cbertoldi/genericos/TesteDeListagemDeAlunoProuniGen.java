...
public class TesteDeListagemDeAlunoProuniGen {

  @Inject
  private ListagemDeAlunoProuniGen listagem;
  ...
  public void deve_listar_alunos_bolsitas() {
    List<Aluno> contra = AlunosFalso.getBolsistasProuni();
